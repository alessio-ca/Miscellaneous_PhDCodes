...
If you want to practice on particle tracking, the folder "Data for particle tracking" contains two versions of a data series (a folder with tiff images and a .movie file). 
