function [tau,MSD,ACF,MSD_vec,ACF_vec]=DLS_Analysis_Javi(t,data,varargin)
% DLS_Analysis_Javi Estimation of MSD and G* from DWS autocorrelation
% data
%
...
for j = 1:size(data,2)
    ...
    CritPts = find(ACF_ToFit< 0.2*ACF_ToFit(1));
    ...
    dataTemp = ACF_ToFit(1:CritPts)/beta;
    ...
    switch fitmeth
        case 'CON'
            ...
            for i = 2:10
                ...
                [g,yfit,~] = CONTIN_Rilt(tTemp,dataTemp,s,g0,alpha,'logarithmic',100,[],[],[],[],[]);
                coarse_g = g;
                coarse_s = s;
                disp(' ')
            end
