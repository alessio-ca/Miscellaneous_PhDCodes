...
MSD = 6*D*t;
Jfactor = ((kB*T)/(pi*R))^(-1);
[omega_H20,G_H20]=MSDtoG_Evans_oversampling(t,MSD,1e+4,'Jfactor',Jfactor,'BM',0);
...
[omega_Max,G_Max]=MSDtoG_Evans_oversampling(t,MSD,1e+5,'Jfactor',Jfactor,'BM',1);
...
[omega_Max_Sol,G_Max_Sol]=MSDtoG_Evans_oversampling(t,MSD,1e+7,'Jfactor',Jfactor,'BM',1);
