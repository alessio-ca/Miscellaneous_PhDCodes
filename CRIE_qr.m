function [R,c] = CRIE_qr(A,b)
%CRIE_qr Computes the qr factorization of the problem Ax=b (x unknown)
%
% CRIE_qr(A,b)
%
% Given a matrix A (m x n, with m > n) and a vector b (m x 1), 
% CRIE_qr computes the QR factorization of the problem Ax = b (x 
