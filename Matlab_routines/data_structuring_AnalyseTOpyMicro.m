function [] = data_structuring_AnalyseTOpyMicro(filename,targetFolder)

% This program takes an original track.csv files as produced by Analyse (on
% the POM 0.26 microscope) and restructures it to be used for various microrheology routines.
...
mkdir(targetFolder)
dlmwrite([targetFolder,'Trackfile.txt'], res, ' ');
