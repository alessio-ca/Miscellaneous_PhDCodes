% DB (13/11/08): Changed histeq to match a flat histogram rather than a target histogram. This should give better contrast enhancement.
% DB (13/11/19): Commented out histeq because it was conferring no benefit and in fact sometimes created problems
% DB (13/11/22): Just renamed to signal that this goes with other series 2x programs. The runtime procedure seeks to eliminate most graphical IO so the scripts can be run efficiently over SSH.
